...
include ('procesos/conexion.php');
    ...
    include('procesos/obtener_todas_reservas_canceladas.php');
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["btn_asistencia"])) {
    ...
    <div class='row'>
            <div class='col-12 col-md-9'>
                ...
                <li class='nav-item navNaranja'>
                    <a class='nav-link active' href='reservasAdmin_canceladas.php'>Canceladas</a>
                </li>
                <li class='nav-item navNaranja'>
...
//cargar logo
    ...
    logo.src = 'imgs/logo.png';  // Reemplaza 'ruta_del_logo.jpg' con la ruta de tu logo
        ...
        echo "<br><br><br><h2>Actualmente hay reservas canceladas</h2><br><br>";        
        echo "</div>";
    }
...
?>
   ...
   var columns = ["ID de Reserva", "Nombre", "Apellido", "Cédula", "Número de Mesa", "Número de Personas", "Hora de Inicio", "Hora de Fin", "Fecha", "Asistencia", "Estado"];
    ...
    doc.setFontSize(22);
    doc.text("Reservas Canceladas", 108, 45);
    doc.autoTable({
        columns: columns,
        body: data,
